...
const FormAddManager = ({ setDeleted, values ,setValues }) => {
            ...
            <StyleForm>
                ...
                <StyleSmaleDiv>
                    <div className='one-input'>
                        <StyleLabel>اضف شعار للمشرف</StyleLabel>
                ...
                <StyleSmaleDiv>
                    <div className='one-input'>
                        ...
                        <input type="text" placeholder='اكتب الاسم بالانجليزي' value={values.name} onChange={(e) => setValues({ ...values, name: e.target.value })} />
                    </div>
