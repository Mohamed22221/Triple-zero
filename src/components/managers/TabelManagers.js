...
const TabelManagers = ({searchSort , setSortSearch ,HandelShowCustomer }) => {
   
     const UserData = useSelector(state => state.managers.managers)
  ...
  <MainTabel>
    ...
    <Tabel>
        ...
        {sortedField.filter((item)=>{
            ...
            return (
                <TrBody key={index}>
                    <td><Link className='my-2' to={`/Managers/clint/${user.id}`}><img src={Logo3} alt="logo" /></Link></td>
                    <td>
                        <Link className='text-link' to={`/Managers/clint/${user.id}`}>{user.id}#</Link>
                    </td>
                    <td>
                        <span>{user.name}</span>
                    </td>
                    ...
                    <td >
                     ...
                     <Link to={`/Managers/clint/${user.id}`}> التفاصيل</Link>
                     <Link to={`/Managers/clint/${user.id}`}>بيانات العميل</Link>
                     </div>
                    </td>
                </TrBody>
            )
